...
func (c *Client) readPump() {
	...
	for {
		...
		fmt.Printf("Server recieved MES :: %+v\n", len(message))
		if err != nil {
		...
		// mes := strings.Split(string(message), string(space))
		// fmt.Printf("PPPPPPPPPPP = %+v\n", len(mes))
		// for key := range mes {
...
func serveWs(hub *Hub, w http.ResponseWriter, r *http.Request) {
	...
	fmt.Printf("HUB clients length :: %+v\n", len(hub.clients))
...
func main() {
	...
	r.GET("/cards", func(c *gin.Context) {
		c.JSON(http.StatusOK, defaultCards)
	})
